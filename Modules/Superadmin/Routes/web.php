...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->group(function () {
    ...
    Route::post('/subscription/flytepay', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'pay_flytepay'])->name('subscription.flytepay');
    
    Route::get('/payment-success', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'statusSuccess'])->name('subscription.success');
    Route::get('/payment-failed', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'statusFailed'])->name('subscription.failed');
    Route::get('/payment-cancel', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'statusCancel'])->name('subscription.cancel');
    Route::get('/payment-ipn', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'statusIpn'])->name('subscription.ipn'); 
