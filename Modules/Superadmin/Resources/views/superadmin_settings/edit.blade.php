...
<section class="content">
     @if (session('success'))
        <div class="alert alert-success" role="alert" data-bs-toggle="tooltip" data-bs-placement="top"
    ...
    @if (session('error'))
        <div class="alert alert-danger" role="alert" data-bs-toggle="tooltip" data-bs-placement="top"
            title="{{ session('error') }}">
            {{ session('error') }}
        </div>
    @endif
