...
<section class="content content-custom no-print">
  ...
  <div class="row row-custom">
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
      <div class="info-box info-box-new-style">
        <span class="info-box-icon"><img style="width: 32px;" src="{{ asset('icons/money.png') }}" alt=""></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
      <div class="info-box info-box-new-style">
        <span class="info-box-icon"><img style="width: 32px;" src="{{ asset('icons/sales.png') }}" alt=""></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
      <div class="info-box info-box-new-style">
        <span class="info-box-icon">
          <img style="width: 32px;" src="{{ asset('icons/payment-method.png') }}" alt="">
        </span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
      <div class="info-box info-box-new-style">
        <span class="info-box-icon">
          <img style="width: 32px;" src="{{ asset('icons/bill.png') }}" alt="">
        </span>
  ...
  <div class="row row-custom">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
      <div class="info-box info-box-new-style">
        <span class="info-box-icon">
          <img style="width: 32px;" src="{{ asset('icons/expense.png') }}" alt="">
        </span>
