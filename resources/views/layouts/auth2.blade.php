...
<html>
<<<<<<< HEAD=======>>>>>>> a5887849ead7a039749eda4f7e9a1c4abb55080b
    ...
    <head>
        ...
        <<<<<<< HEAD <title>@yield('title') - {{ config('app.name', 'POS') }}</title>
            =======
            <title>@yield('title') - {{ config('app.name', 'POS') }}</title>
            >>>>>>> a5887849ead7a039749eda4f7e9a1c4abb55080b
        ...
        <div class="container-fluid">
            <div class="row eq-height-row">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12 right-col eq-height-col">
                    <div class="row">
                        <<<<<<< HEAD <div class="col-md-3 col-xs-4" style="text-align: left;">
...
@endforeach
        ...
        <<<<<<< HEAD @include('layouts.partials.javascripts') <!-- Scripts -->
